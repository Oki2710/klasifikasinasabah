...
CREATE TABLE `nasabah` (
  ...
  `suku_bunga` enum('1','2','3','4','5','6','7') COLLATE utf8mb4_unicode_ci NOT NULL,
  `jangka_waktu` enum('1','2','3','4','5') COLLATE utf8mb4_unicode_ci NOT NULL,
  `plafond_kredit` int NOT NULL,
